...
import com.example.myapplication.observer.ShareFragmentViewModel;
...
public class BlankFragmentOne extends Fragment {
    ...
    private ShareFragmentViewModel model;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        model = new ViewModelProvider(this).get(ShareFragmentViewModel.class);
        MutableLiveData<String> liveData = model.getLiveData();
        liveData.observe(this, new Observer<String>() {
            @Override
            public void onChanged(String s) {
                Log.d("BlankFragment", "onChanged: this is BlankFragmentOne get the : " + s);
            }
        });
    }
